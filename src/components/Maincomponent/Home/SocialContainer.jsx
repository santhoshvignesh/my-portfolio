    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a
            href="https://www.linkedin.com/in/vignesh-a-devdesign/"
            target="blank"
            aria-label="LinkedIn"
        ...
        <li className="icon-content">
          <a
            href="https://github.com/santhoshvignesh"
            target="blank"
            aria-label="GitHub"
            data-social="github"
          >
        ...
        <li className="icon-content">
          <a
            href="https://www.instagram.com/vs_editz2k3?igsh=cXFnYXUzemxvMGFr"
            target="blank"
        ...
        <li className="icon-content">
          <a
            href="https://www.behance.net/santhoshvignesh"
            target="blank"
            aria-label="Behance"
            data-social="behance"
          >
